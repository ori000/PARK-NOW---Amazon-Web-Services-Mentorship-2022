...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> users=FirebaseFirestore.instance.collection("User Info").snapshots();
    ...
    final docRef=FirebaseFirestore.instance.collection("User Info").doc(user.email!);
    docRef.get().then(
            (DocumentSnapshot doc){
          var email=doc.data() as Map<String,dynamic>;
          firstname = email["First Name"];
          lastname= email["Last Name"];
          store_email=email["Email Address"];
                    ...
                    children: [
                      ...
                      ListTile(
                        leading: Icon(Icons.screen_lock_landscape_rounded,
                          size: _drawerIconSize, color: Theme
                              .of(context)
                              .accentColor,),
                      ...
                      ListTile(
                        leading: Icon(
                            Icons.login_rounded, size: _drawerIconSize,
                            color: Theme
                                .of(context)
                                .accentColor),
                        title: Text('Login Page',
                          style: TextStyle(
                              fontSize: _drawerFontSize, color: Theme
                              .of(context)
                              .accentColor),
                        ),
                        onTap: () {
                      ...
                      ListTile(
                        leading: Icon(
                            Icons.person_add_alt_1, size: _drawerIconSize,
                            color: Theme
                                .of(context)
                                .accentColor),
                      ...
                      ListTile(
                        leading: Icon(
                          Icons.password_rounded, size: _drawerIconSize,
                          color: Theme
                              .of(context)
                              .accentColor,),
                      ...
                      ListTile(
                        leading: Icon(
                          Icons.logout_rounded, size: _drawerIconSize,
                          color: Theme
                              .of(context)
                              .accentColor,),
                        title: Text('Logout',
